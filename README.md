## gazebo9_ros_pkgs (kinetic) - 2.5.19-1

The packages in the `gazebo9_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo9_ros_pkgs --edit` on `Tue, 04 Jun 2019 18:31:13 -0000`
...
## gazebo9-ros-pkgs (kinetic) - 2.5.17-3

The packages in the `gazebo9-ros-pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo9-ros-pkgs --track kinetic --ros-distro kinetic` on `Fri, 09 Nov 2018 14:35:28 -0000`
...
Version of package(s) in repository `gazebo9-ros-pkgs`:

- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: unknown
- rosdistro version: `null`
- old version: `2.5.17-2`
- new version: `2.5.17-3`
...
## gazebo9-ros-pkgs (kinetic) - 2.5.17-2

The packages in the `gazebo9-ros-pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo9-ros-pkgs --track kinetic --ros-distro kinetic` on `Fri, 09 Nov 2018 13:27:28 -0000`
...
- release repository: unknown
- rosdistro version: `null`
- old version: `2.5.17-1`
- new version: `2.5.17-2`
...
## gazebo9 (kinetic) - 2.5.17-1

The packages in the `gazebo9` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release gazebo9 --track kinetic --ros-distro kinetic --edit` on `Fri, 09 Nov 2018 11:56:53 -0000`
...
Version of package(s) in repository `gazebo9`:

- upstream repository: https://github.com/ros-simulation/gazebo_ros_pkgs.git
- release repository: unknown
- rosdistro version: `null`
- old version: `2.5.17-0`
- new version: `2.5.17-1`
...
## gazebo9_ros_pkgs (kinetic) - 2.5.17-0

The packages in the `gazebo9_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --rosdistro kinetic --track kinetic gazebo9_ros_pkgs` on `Tue, 16 Oct 2018 09:28:41 -0000`
...
## gazebo9_ros_pkgs (lunar) - 2.7.6-0

The packages in the `gazebo9_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --rosdistro lunar --track lunar gazebo9_ros_pkgs` on `Tue, 16 Oct 2018 09:21:26 -0000`
...
## gazebo9_ros_pkgs (lunar) - 2.7.4-1

The packages in the `gazebo9_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --track lunar --ros-distro lunar gazebo9_ros_pkgs --edit` on `Tue, 13 Feb 2018 18:58:05 -0000`
...
## gazebo9_ros_pkgs (lunar) - 2.7.4-0

The packages in the `gazebo9_ros_pkgs` repository were released into the `lunar` distro by running `/usr/bin/bloom-release --track lunar --ros-distro lunar gazebo9_ros_pkgs --edit` on `Tue, 13 Feb 2018 18:03:37 -0000`
...
## gazebo9_ros_pkgs (kinetic) - 2.5.15-0

The packages in the `gazebo9_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo9_ros_pkgs --edit` on `Tue, 13 Feb 2018 01:58:32 -0000`
...
- release repository: unknown
- rosdistro version: `null`
- old version: `2.5.14-2`
- new version: `2.5.15-0`
...
## gazebo9_ros_pkgs (kinetic) - 2.5.14-2

The packages in the `gazebo9_ros_pkgs` repository were released into the `kinetic` distro by running `/usr/bin/bloom-release --track kinetic --ros-distro kinetic gazebo9_ros_pkgs --edit` on `Tue, 13 Feb 2018 01:05:14 -0000`
